...
metadata_file <- "C:/Users/katmu/Dropbox/Valdivia\ Lab/Projects/LAD\ Timeseries/Data\ for\ Analysis/metadata.txt"
```
...
metadata <- read.delim(metadata_file, sep = "\t", header = FALSE)
```
